...
addEventSubmit.addEventListener("click", () => {
  ...
  console.log('hora ini' + eventTimeFrom.value)
  ...
  //dar formato al evento para añadir a la bd
  /*
  const newEvent = {
    start: year + '-' + doubledigit(month + 1) + '-' + doubledigit(activeDay)+ ' '+ timeFrom,
    end: year + '-' + doubledigit(month + 1) + '-' + doubledigit(activeDay)+ ' '+ timeTo,
    descripcion: eventTitle,
    tipo: 'clase',
    usuario: 'daphne@gmail.com',
    numLab: '2'
  };*/

  //axios post para agregar a la bd
